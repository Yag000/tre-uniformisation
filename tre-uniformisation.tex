	...
	\begin{itemize}
        \item $\bsubLR$\vspace{0.15cm}\\ 
		      ...
		      \begin{itemize}
			      ...
			      \item If $q = \delta (p,q,a) \in \Sa A$ where $p,q \in \Sa A$ and $a \in \Sigma$. Then b the induction hypothetses tehre exists
			            $t'$ such that $\interpret A {t'} = p$ and $t''$ such that $\interpret A {t''} = q$.
