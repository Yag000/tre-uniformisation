...
\begin{proof}
    ...
    \todo{$\init$ should be on the choice function, maybe writing another one ? (choice\_init) Or extending the current one to something like $\parts Q \uplus \set {\emptyset}$ to represent leaves.}\\
	\todo{Find a way to fix $r$}
