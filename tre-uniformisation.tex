	...
	\[
		\begin{aligned}
			...
			\begin{aligned}
				 ...
				 & \quad u'' = u \land u', X = (\ldots, 0, \ldots) \in \{0,1\}^n \text{ at position } i, \\
			...
			\begin{aligned}
				 & ((q,0), (q', 0), (a, X), (q'',1)) \mid                              \\
				 & \quad X = (\ldots, 1, \ldots) \in \{0,1\}^n \text{ at position } i, \\
				 & \quad (q, q', (a, X), q'') \in \Delta
			\end{aligned}
			\right\}.
		\end{aligned}
	\]
	can decide $\phi$. If the existential quantification is performed on a variable of the second order we check 
    the automation remains the same but instead of looking at a single variable in the transition function we look at all 
    of the ones present in the set.
