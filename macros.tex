...
\addtheorem{coro}{Corollary}
\addtheorem{lemma}{Lemma}
\addtheorem{proposition}{Proposition}
\theoremstyle{definition}
\addtheorem{definition}{Definition}
\addtheorem{assumption}{Assumption}
\addtheorem{remark}{Remark}
\addtheorem{example}{Example}
...
\knowledgenewrobustcmd \equal {\cmdkl {\text{equal}}}

\knowledgenewrobustcmd \Sa [1] {\cmdkl {\text{S}_{#1}}}


\knowledgenewrobustcmd \Atimes {\cmdkl {\times}}

\knowledgenewrobustcmd \choice {\cmdkl {\text{choice}}}
