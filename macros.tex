...
\KnowledgeNewDocumentCommand\Nodes{}
	{\cmdkl {\mathrm{Nodes}}}
...
\knowledgenewrobustcmd  \singleState {\cmdkl {\text{single\_state}}}
\knowledgenewrobustcmd  \rootNode  {\cmdkl {\text{root\_node}}}
\knowledgenewrobustcmd  \inSet  {\cmdkl {\text{in\_set}}}
\knowledgenewrobustcmd  \leafNode  {\cmdkl {\text{leaf\_node}}}
\knowledgenewrobustcmd \innerNodes  {\cmdkl {\text{inner\_nodes}}}
\knowledgenewrobustcmd \Aut {\cmdkl {\text{Aut}}}
