...
\begin{definition}
	...
	\begin{itemize}
		...
		\item $Q$ is a finite set of "states".
		      ...
		      \itemAP $\DeltaA \subseteq Q \times Q \times \Sigma \times Q$ is the ""transition relation"".
...
\begin{definition}
	\AP We say that a language is ""MSO-definable"" if there exists a "MSO" formula $\phi$ such that
	\[
...
\begin{definition}["Uniformiser automaton"]
	...
	\begin{itemize}
		...
		\item $\deltau((X,X'),(Y,Y'),a) = (\deltaA(X,Y,(a,*)), \deltauu(X',Y',a))$ with:
		      \[
...
\begin{proof} \todo{change : to $\mid$} \todo{knoledge all *}
	...
	\begin{itemize}
		\item Lets suppose $t_{P,P'} \cong t_{Q,Q'}$.
		      ...
		      $\deltaA_A (t_{T,T'}, X) = \deltaA_A(p,p,(a, X(\treeroot))) \in T'$.
